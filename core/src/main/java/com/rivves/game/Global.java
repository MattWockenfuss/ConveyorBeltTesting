...
public class Global {
    ...
    public static final String NAME = "Alchemitorio";
...
public class GameScreen implements Screen {
    ...
    private void spawnRaindrop() {
        ...
        raindrop.y = height;//remember bottom left is 0,0
        raindrop.width = 64;
        raindrop.height = 64;
    ...
    public void render(float delta) {
        ...
        // all drops
        game.batch.begin();
        game.font.draw(game.batch, "Drops Collected: " + dropsGathered, 10, height - 10);
